...
BATCH_SIZE = 16        # Размер батча; может увеличить требование к памяти
...
IMG_SIZE = 112         # Размер кадра (высота и ширина)
...
TEST_VIDEO_PATH = r"C:\Users\zfann\PycharmProjects\test_ai_yolo_detect\datasets\fight\test4.mp4"
